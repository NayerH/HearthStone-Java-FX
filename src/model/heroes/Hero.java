...
public abstract class Hero implements MinionListener {
	...
	public String toString(){
		String s = "<html><font color='white'>Hero Name: " + this.name + "<br>Current HP: " + this.currentHP + "<br>Mana Crystals: " + this.currentManaCrystals + "/" + this.totalManaCrystals +"</font></html>";
		return s;
	}
